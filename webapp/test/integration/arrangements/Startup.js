sap.ui.define([
	"sap/ui/test/Opa5",
	"journeyPlanner/JourneyPlanner/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("journeyPlanner.JourneyPlanner.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "journeyPlanner.JourneyPlanner",
					async: true
				},
				hash: oOptions.hash,
