sap.ui.define([
	...
	return Opa5.extend("journeyPlanner.JourneyPlanner.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["journeyPlanner/JourneyPlanner/localService/mockserver"], function (mockserver) {
